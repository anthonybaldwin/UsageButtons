...
func TestSumResultsUSD_DollarsNotCents(t *testing.T) {
	got := sumResultsUSD([]costResult{
		{Amount: &costAmount{Value: 0.06, Currency: "usd"}}, // $0.06
		{Amount: &costAmount{Value: 12.50, Currency: "usd"}},
		{Amount: nil},                                        // skipped
		{Amount: &costAmount{Value: 99.99, Currency: "eur"}}, // skipped (non-USD)
		{Amount: &costAmount{Value: 1.00, Currency: ""}},     // empty currency treated as USD
	})
