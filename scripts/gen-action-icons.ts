...
const RAW_SVGS: Record<string, RawSvg> = {
  warp: {
    paths: [
      { d: "M50.564 9.5L87.855 9.5C93.972 9.5 98.911 14.601 98.911 20.919L98.911 64.355C98.911 70.673 93.972 75.774 87.855 75.774L34.45 75.774L50.564 9.5Z", fill: true },
      { d: "M40.859 22.06L10.828 22.06C4.844 22.06 0 27.06 0 33.2L0 76.637C0 82.777 4.844 87.777 10.828 87.777L47.779 87.777L49.246 82.024L26.408 82.024L40.859 22.06Z", fill: true },
    ],
  },
  openrouter: {
    paths: [
